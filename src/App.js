  ...
  return (
    <div className={`font-sans antialiased transition-colors duration-300 ${darkMode ? "bg-slate-950 text-slate-200" : "bg-white text-slate-800"}`}>
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-12 pb-16">
        ...
        <section id="education" className="py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className={`p-6 rounded-xl shadow-lg transition-transform duration-300 transform hover:scale-105 ${darkMode ? 'border border-slate-700/50 bg-slate-800/50' : 'border border-slate-200 bg-white/50'}`}>
              ...
              <p className={`text-sm ${darkMode ? 'text-slate-400' : 'text-slate-500'}`}>Pursuing | Dr. J J Magdum College of Engineering, Jaysinghpur</p>
        ...
        <section id="projects" className="py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
                { title: "Smart garbage sagrigation", desc: "uses sensors to auto-sort waste into wet, dry, and recyclable types—making disposal cleaner and smarter." },
        ...
        <section id="contact" className="py-20">
          ...
          <div className="flex justify-center space-x-6 mt-12">
            ...
            <a href="https://github.compranav870" target="_blank" rel="noopener noreferrer" className={`text-3xl transition-colors duration-200 ${darkMode ? 'hover:text-indigo-400' : 'hover:text-indigo-600'}`}>
              {/* GitHub Icon */}
            ...
            <a href="https://instagram.com/its_pranav._15/" target="_blank" rel="noopener noreferrer" className={`text-3xl transition-colors duration-200 ${darkMode ? 'hover:text-indigo-400' : 'hover:text-indigo-600'}`}>
              {/* Instagram Icon */}
      ...
      <footer className={`py-8 text-center text-sm border-t ${darkMode ? 'border-slate-700/50' : 'border-slate-200'}`}>
        ...
        <p className={`text-slate-400 ${darkMode ? '' : 'text-slate-500'}`}>© {new Date().getFullYear()} Pranav Javalekar </p>
      </footer>
